...
public class RestaurantsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        listItems.add(new ListItem("Fin's at Sharkey's", getContext().getString(R.string.restaurant2), "1600 Harbor Dr S, Venice, FL 34825", "+1 941-999-3467", "12pm-10pm", R.drawable.finsatsharkeys));
        ...
        listItems.add(new ListItem("Paradise Grill", getContext().getString(R.string.restaurant4), "80 Spring St, New York, NY 10012, USA", "+1 212-965-1414", "12PM–1AM", R.drawable.paradisegrill));
